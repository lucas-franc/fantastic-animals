...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initTime)\n/* harmony export */ });\nfunction initTime() {}\nvar expedient = document.querySelector(\"[data-week]\");\nvar weekdays = expedient.dataset.week.split(\",\").map(Number);\nvar weekExpedient = expedient.dataset.time.split(\",\").map(Number);\nvar dateNow = new Date();\nvar dayNow = dateNow.getDay();\nvar timeNow = dateNow.getHours();\nvar openWeek = weekdays.indexOf(dayNow) !== -1;\nvar openDay = timeNow >= weekExpedient[0] && timeNow <= weekExpedient[1];\nif (openDay && openWeek) {\n  expedient.classList.add(\"open\");\n}\n\n//# sourceURL=webpack://fantastic-animals/./js/modules/time.js?");
